          ...
          <div class="card-body">
            ...
            <div class="flex flex-row justify-between">
              <div class="tooltip" data-tip="Add rule">
                <button class="btn btn-ghost btn-primary" @click="openAddRule">
                  Add Rule <font-awesome-icon :icon="Icons.Add" />
                </button>
              </div>
            ...
            <table class="table table-fixed w-full ">
              ...
              <tbody>
                <tr class="hover cursor-pointer" v-for="rule in currentRules" :key="rule.effects"
                  ...
                  <td class="font-mono">
                    <div class="overflow-hidden text-ellipsis whitespace-nowrap">{{ rule.deny_routes?.join(", ") || '-'
                      }}</div>
                  </td>
                </tr>
              </tbody>
