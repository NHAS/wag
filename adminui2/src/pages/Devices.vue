          ...
          <div class="card-body">
            <div class="flex flex-row justify-between">
              <div class="tooltip" data-tip="Create Registration Token">
                <button class="btn btn-ghost btn-primary" @click="isCreateTokenModalOpen = true">Add Device <font-awesome-icon
            ...
            <table class="table table-fixed w-full">
              ...
              <tbody>
                <tr class="hover group" v-for="device in currentDevices" :key="device.internal_ip">
                  ...
                  <td class="font-mono">
                    <div><font-awesome-icon class="cursor-pointer" @click="updateDevice([device.internal_ip], (device.is_locked) ? DeviceEditActions.Unlock : DeviceEditActions.Lock)" :icon="device.is_locked ? Icons.Locked : Icons.Unlocked" :class="device.is_locked ? 'text-error' : 'text-secondary'"  /></div>
                  </td>
                  <td class="font-mono">
                  ...
                  <td class="font-mono relative">
                    <div class="overflow-hidden text-ellipsis whitespace-nowrap">{{ device.last_endpoint == '<nil>' ? '-' : device.last_endpoint}}</div>
