    ...
    <div v-else>
      ...
      <div class="mt-6 flex flex-wrap gap-6">
        ...
        <div class="tabs tabs-boxed">
          ...
          <a
            class="tab"
            :class="{ 'tab-active': activeTab === 'webservers', 'font-bold': activeTab === 'webservers' }"
        ...
        <div class="flex flex-wrap w-full gap-4">
          ...
          <div v-else-if="activeTab === 'authentication'" class="flex flex-wrap w-full gap-4">
            ...
            <div
              v-if="loginSettingsData.enabled_mfa_methods.indexOf('oidc') != -1"
                    ...
                    <div role="tabpanel" class="tab-content p-10">
                      ...
                      <template v-if="server.static_certificates">
                          ...
                          <label class="label font-bold" :for="`privateKey-${server.server_name}`">
                            <span class="w-full">{{
                              server.private_key === 'Valid'
                                ? 'Valid Private Key'
                                : server.private_key.length > 0
                                  ? ''
                                  : 'Please add private key'
                            }}</span>
                            <span class="label-text btn">{{
                              server.private_key.length > 0 ? 'Change Private Key' : 'Add Private Key'
                            }}</span>
                          </label>
                          <input
                            type="file"
                        ...
                        <div class="alert alert-warning mt-4 mb-2">
                          <div class="text-sm">
                            <strong>Note:</strong> Uploaded certificates will override ACME certificates. Make sure your certificate matches
                      ...
                      <label class="label font-bold">
                        ...
                        <span
                          :class="serverCanHaveTLS(server.domain) || server.static_certificates ? '' : 'tooltip'"
