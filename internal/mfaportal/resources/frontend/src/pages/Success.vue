  ...
  <div class="auth-card">
    ...
    <div class="content-section">
      ...
      <div class="network-details-container mb-6">
        <!-- Loading State -->
        <div
          v-if="isLoadingDetails && !hasLoadedOnce"
          ...
          <div class="space-y-6">
            <div class="skeleton-section">
              <div class="flex items-center gap-2 mb-3">
                <div
                  class="w-2 h-2 bg-base-300 rounded-full animate-pulse"
                ></div>
              ...
              <div class="flex flex-wrap gap-2">
                <div
                  class="h-8 bg-base-300 rounded-lg w-24 animate-pulse"
                ></div>
                <div
                  class="h-8 bg-base-300 rounded-lg w-32 animate-pulse"
                ></div>
                <div
                  class="h-8 bg-base-300 rounded-lg w-20 animate-pulse"
                ></div>
              </div>
            </div>
            ...
            <div class="skeleton-section">
              ...
              <div class="flex flex-wrap gap-2">
                <div
                  class="h-8 bg-base-300 rounded-lg w-28 animate-pulse"
                ></div>
                <div
                  class="h-8 bg-base-300 rounded-lg w-36 animate-pulse"
                ></div>
              </div>
            </div>
          </div>
        ...
        <div
          ...
          :class="{
            'opacity-0': isLoadingDetails,
            'opacity-100': !isLoadingDetails,
          }"
        >
          <h4
            class="font-semibold mb-4 flex items-center justify-between text-lg"
          >
            ...
            <div class="flex gap-2">
              <button
                ...
                :disabled="!sessionDetails || isLoadingDetails"
              ...
              >
                <svg
                  ...
                  :class="{ 'animate-spin': isLoadingDetails }"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div class="space-y-6">
            <div v-if="sessionDetails?.Public?.length" class="resource-section">
              <div class="flex items-center gap-2 mb-3">
                ...
                <span class="font-medium"
                  >Public Routes: {{ sessionDetails.Public.length }}</span
                >
              </div>
            </div>
            ...
            <div v-if="sessionDetails?.MFA?.length" class="resource-section">
              <div class="flex items-center gap-2 mb-3">
                ...
                <span class="font-medium"
                  >MFA Protected Routes: {{ sessionDetails.MFA.length }}</span
                >
              </div>
            </div>
          </div>
        ...
        >
          ...
          <p class="text-sm opacity-70">
            Unable to fetch network access information.
          </p>
        </div>
      </div>
      ...
      <div class="text-center mt-6">
        <p class="text-xs opacity-60 mt-2">
          {{ info.state.userInfo?.versions.wag }}
        </p>
      </div>
    </div>
  </div>
