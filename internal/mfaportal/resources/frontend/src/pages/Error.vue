...
const errorMessage = route.query.m as string || "Something went wrong. Please try again later.";
...
<template>
  <div class="flex flex-col items-center justify-center space-y-6 py-8">
    ...
    <div class="relative">
      ...
      <div class="absolute -top-1 -right-1 w-6 h-6 bg-error rounded-full flex items-center justify-center">
    ...
    <!-- Error Message -->
    <div class="bg-error/10 border border-error/20 rounded-lg p-4 max-w-md w-full">
    ...
    <!-- Contact Information -->
    <div class="text-center space-y-2 pt-4 border-t border-base-300 w-full max-w-md">
