...
require (
	github.com/NHAS/tetcd v0.0.54-beta.0.20260722215238-cbb7a632571a // indirect
...
replace golang.zx2c4.com/wireguard => github.com/NHAS/wireguard-go v0.0.0-20250612003640-64654948f25c
